...
if ( ! function_exists( 'themify_theme_enqueue_scripts' ) ) {
	...
	function themify_theme_enqueue_scripts() {
		...
		if(isset($_SERVER['HTTP_USER_AGENT'])){
		    ...
		    if ($browser == false){
			    wp_enqueue_script( 'theme-scroll', THEME_URI . '/js/jquery.scroll.min.js', null, $theme_version, true );
		    }
		}

		// Slide mobile navigation menu
		wp_enqueue_script( 'slide-nav', themify_enque(THEME_URI . '/js/themify.sidemenu.js'), null, '3.5.4', true );
...
function themify_theme_mega_menu_query( $args ) {
	$args['posts_per_page'] = themify_get( 'setting-mega_menu_posts', 4 );
	return $args;
}
