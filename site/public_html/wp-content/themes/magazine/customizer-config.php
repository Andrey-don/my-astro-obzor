...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'main_nav_dropdown_link_color' => array(
			...
			'selector' => '#main-nav ul li a, #main-nav .mega-sub-menu li:after, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, .fixed-header #main-nav ul a, #main-nav .has-mega-column > .sub-menu a',
			'prop' => 'color',
		),
		...
		'main_nav_dropdown_link_background' => array(
			...
			'selector' => '#main-nav ul li a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, #main-nav .has-mega-column > .sub-menu a',
			'prop' => 'background',
		),
		...
		'main_nav_dropdown_link_hover_color' => array(
		  ...
		  'selector' => '#main-nav ul a:hover, #main-nav .current_page_item ul a:hover, #main-nav ul .current_page_item a:hover, #main-nav .current-menu-item ul a:hover, #main-nav ul .current-menu-item a:hover, .fixed-header #main-nav ul a:hover, #main-nav .has-mega-column > .sub-menu a:hover',
		  'prop' => 'color',
		),
		...
		'main_nav_dropdown_link_hover_background' => array(
		  ...
		  'selector' => '#main-nav ul a:hover, #main-nav .current_page_item ul a:hover, #main-nav ul .current_page_item a:hover, #main-nav .current-menu-item ul a:hover, #main-nav ul .current-menu-item a:hover, #main-nav .has-mega-column > .sub-menu a:hover',
		  'prop' => 'background',
		),
		...
		'mobile_menu_icon_background' => array(
			...
			'selector' => '.mobile_menu_active #headerwrap #menu-icon, #pagewrap #headerwrap #menu-icon-top',
			'prop' => 'background',
			'global' => true,
		),
